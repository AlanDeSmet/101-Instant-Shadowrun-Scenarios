\begin{scenario}{Damien Knight and the Ammo Factory}
	{Unspecified}
	{Six Golden Bullets provide early access to Ares new theme park.}
	{Bull}
	{2009-05-08}
...
Finding the Golden Bullet is a \emph{major} event in the news. Knight and Ares has been promoting the \emph{hell} out of this event, and unless the runners want to chuck (or sell off) this opportunity of a lifetime, they get a \emph{big} news spotlight on them. Anyone who wants a shot at this prize may try to take the Golden Bullet from the runners by force, and any enemies who want to nail the runners to the wall may find the unmanned theme park a prime location to try and knock the players off.
...
Damien Knight is \emph{very} confident about the automated security in his new factory. \emph{Too} confident, in fact. Halfway through your tour of Ammo World, the automated security turns on it's creator, and it's up to you to get Damien out of this Robotic Hell in one piece, as well as the rest of the Tour Groups. After all, dead Tourists make for \emph{bad} PR, and Damien will be \emph{very} grateful to the runners if they get them all out in one piece.

If only those damned MPA LMPA bots would quit \emph{singing}!
